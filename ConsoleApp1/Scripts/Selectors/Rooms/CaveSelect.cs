    ...
    public static class CaveSelect
    {
        public static void intocave()
        {
            ...
            if (Program.save.progress.npc.isAnneok && Program.save.progress.npc.isSadieok)
            {
                ...
                Console.ResetColor();
                Task.Delay(5000);
                var process = new ProcessStartInfo() { FileName = "https://www.youtube.com/watch?v=dQw4w9WgXcQ&t=1s", UseShellExecute = true };
            ...
            while (intocave) 
            {
                ...
                switch (response.ToUpper())
                {
                    ...
                    case "FEEL AROUND THE ROOM TO FIND MORE STUFF":
                        Program.save.progress.caveoptions.Remove("Feeling around the room you find a small dirt pile");
